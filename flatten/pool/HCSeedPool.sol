...
// File contracts/pool/HCSeedPool.sol
...
/**
 * @title HC Seed Pool Contract
 * @author HASHLAND-TEAM
 * @notice In this contract seed round users can harvest HC
 */
contract HCSeedPool is ReentrancyGuard {
    ...
    uint256 public constant blockPerHalfYear = blockPerYear / 2;

    uint256 public constant hcStartBlock = 12507000;
    uint256 public constant releaseStartBlock = hcStartBlock + blockPerHalfYear;
    uint256 public constant releaseEndBlock = releaseStartBlock + blockPerYear;
    uint256 public constant releasedTotalToken = (60e4 * 1e18 * 90) / 100;
